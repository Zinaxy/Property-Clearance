                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 mt-10">
                        {payment.data.status === "pending" ? (
                            <form onSubmit={submit}>
                                ...
                                <div className="flex items-center justify-end mt-4">
                                    <Link
                                        ...
                                        className="bg-transparent border dark:text-white rounded px-3 py-2 mx-4"
                                    >
                                        Go Back
                                    </Link>
                                    <PrimaryButton
                            ...
                            <div className="text-center font-bold dark:text-white text-2xl">
                                This Payment has been {payment.data.status}
                            </div>
                        )}
                    </div>
                </div>
